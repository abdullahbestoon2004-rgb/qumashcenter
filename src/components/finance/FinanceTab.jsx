...
const TABS = [
  { key: "overview", label: "گشتی" },
  { key: "debts", label: "قەرزەکان" },
  { key: "transactions", label: "مامەڵەکان" },
  { key: "orders", label: "داواکارییەکان" },
];
      ...
      {activeTab === "orders" && (
        <>
          ...
          {sortedOrders.length > 0 ? (
            ...
            <div style={{ background: C.card, border: `1.5px solid ${C.border}`, borderRadius: 14, padding: "30px 18px", textAlign: "center", color: C.muted, fontSize: 14, fontFamily: "Segoe UI,Tahoma,sans-serif" }}>
              هیچ داواکارییەک نییە لەم ماوەیەدا
            </div>
          )}
        </>
      )}
